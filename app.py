...
def admin_dashboard():
    ...
    try:
        ...
        display_students = all_students[:55]
...
def send_defaulter_email():
    ...
    sender_password = "nfub nhuc ysss pqmw"

    subject = "⚠️ Defaulter Notice - Attendance Shortage"
    body = f"""
    Dear {name},

    You have been marked as a DEFAULTER because your attendance is below 75%.

    📌 Action Required:
    Please meet your Class Coordinator immediately and complete the defaulter formalities.

    Ignoring this may affect your academic eligibility.
